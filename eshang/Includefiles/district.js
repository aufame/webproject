var provincearray=new Array(new Option('请选择省份……','0'),new Option('贵州省','12'),new Option('安徽','1'),new Option('山东省','3'),new Option('江苏省','4'),new Option('上海市','5'),new Option('广东省','6'),new Option('浙江省','7'),new Option('福建省','8'),new Option('重庆市','9'),new Option('甘肃省','10'),new Option('广西省','11'),new Option('北京','2'),new Option('海南省','13'),new Option('河北省','14'),new Option('河南省','15'),new Option('黑龙江省','16'),new Option('湖北省','17'),new Option('湖南省','18'),new Option('江西省','19'),new Option('吉林省','20'),new Option('辽宁省','21'),new Option('内蒙古','22'),new Option('宁夏','23'),new Option('青海省','24'),new Option('山西省','25'),new Option('陕西省','26'),new Option('四川省','27'),new Option('天津市','28'),new Option('新疆','29'),new Option('西藏','30'),new Option('云南省','31'),new Option('香港','32'),new Option('澳门','33'),new Option('台湾','34'),new Option('国外与其它','35'));
var cityarray=[];
...
function OnProvinceSelChange(){var myform=window.event.srcElement.form;var ProvinceCode=(myform)?myform.ProvinceList.value:0;if(ProvinceCode){myform.District.options.length=0;for(var i=0;i<cityarray[ProvinceCode].length;i++){ myform.District.add(cityarray[ProvinceCode][i]);}}}
function InitDistrictSelection(myform){var i,j,k,ProvinceCode,districtcode=myform.District.value,getselected=false;myform.ProvinceList.options.length=0;for(i=0;i<provincearray.length;i++){ myform.ProvinceList.add(provincearray[i]);if(!getselected){ ProvinceCode=provincearray[i].value;for(j=0;j<cityarray[ProvinceCode].length;j++){	if(districtcode==cityarray[ProvinceCode][j].value){ myform.District.options.length=0;for(k=0;k<cityarray[ProvinceCode].length;k++){ myform.District.add(cityarray[ProvinceCode][k]);}myform.District.options[j].selected=true;myform.ProvinceList.options[i].selected=true;getselected=true;break;}}}}myform.ProvinceList.onchange=OnProvinceSelChange;}
