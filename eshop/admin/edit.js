...
{message.focus();
  ...
  var arr = showModalDialog("table.htm", "", "dialogWidth:22em; dialogHeight:20em; status:0;help:0");
...
{ message.focus();
  ...
  var range =message.document.selection.createRange();
  var arr = showModalDialog("flash.asp", "", "dialogWidth:20em; dialogHeight:18em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("media.asp", "", "dialogWidth:19em; dialogHeight:12em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("rm.asp", "", "dialogWidth:19em; dialogHeight:12em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("iframe.asp", "", "dialogWidth:22em; dialogHeight:13.5em; status:0;help:0");
